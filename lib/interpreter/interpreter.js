...
_.walk_debug = function(ast){
    console.log('!debug: ' + tree.toStr(this.walk(ast.value)))
}
...
_.walk_media = function(ast){
    ...
    var rulesets = this.rulesets, ruleset;
    ...
    if(res.length){
        if(Array.isArray(res[0])){
            ...
            if(declarations.length && rulesets.length){
                ...
                var newRuleset = new tree.Ruleset(ruleset.selector, 
                    new tree.Block(declarations));
