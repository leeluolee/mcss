 ...
 * TODO: 添加括号才进行计算
 * TODO: srpinf
 * TODO: auto convert values from fnCall like 'sdad' to {type:'STRING', value: 'sdad'}
 * TODO: 引入promise
 * 选择起中的所有符号都不能跳过WS
 * 与其他的atrule不同https://developer.mozilla.org/en-US/docs/Web/CSS/@supports
 */
...
Parser.prototype = {
    ...
    import: function(){
        ...
        if(path.extname(url.value) !== '.css'){
            ...
            var p = io.parse(filename, options)
                .done(function(ast){
                    node.stylesheet = ast;
                })
