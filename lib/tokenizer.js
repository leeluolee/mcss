...
var isPseudoClass = toAssert2(["dir","lang","any-link", "link", "visited", "local-link", "local-link", "target", "scope", "current", "current", "current", "past", "future", "active", "hover", "focus", "active-drop", "valid-drop", "invalid-drop", "enabled", "disabled", "enabled", "disabled", "read-only", "read-write", "placeholder-shown", "default", "default", "checked", "indeterminate", "valid", "invalid", "in-range", "out-of-range", "required", "optional", "required", "optional", "root", "empty", "blank", "nth-child", "nth-last-child", "first-child", "last-child", "only-child", "nth-of-type", "nth-last-of-type", "first-of-type", "last-of-type", "only-of-type", "nth-match", "nth-last-match", 'nth-column', 'nth-last-column', 'not', 'matches', 'before', 'after']);
// color keywords
